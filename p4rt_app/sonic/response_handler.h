 ...
 */
#ifndef PINS_INFRA_P4RT_APP_SONIC_RESPONSE_HANDLER_H_
#define PINS_INFRA_P4RT_APP_SONIC_RESPONSE_HANDLER_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_RESPONSE_HANDLER_H_
