...
#ifndef PINS_P4RT_APP_SONIC_ADAPTERS_DB_CONNECTOR_ADAPTER_H_
#define PINS_P4RT_APP_SONIC_ADAPTERS_DB_CONNECTOR_ADAPTER_H_
...
#endif  // PINS_P4RT_APP_SONIC_ADAPTERS_DB_CONNECTOR_ADAPTER_H_
