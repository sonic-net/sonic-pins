...
#ifndef PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_SONIC_DB_TABLE_H_
#define PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_SONIC_DB_TABLE_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_SONIC_DB_TABLE_H_
