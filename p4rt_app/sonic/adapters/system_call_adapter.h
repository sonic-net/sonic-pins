 ...
 */
#ifndef PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_SYSTEM_CALL_ADAPTER_H_
#define PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_SYSTEM_CALL_ADAPTER_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_SYSTEM_CALL_ADAPTER_H_
