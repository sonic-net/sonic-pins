...
#ifndef PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_PRODUCER_STATE_TABLE_ADAPTER_H_
#define PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_PRODUCER_STATE_TABLE_ADAPTER_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_ADAPTERS_FAKE_PRODUCER_STATE_TABLE_ADAPTER_H_
