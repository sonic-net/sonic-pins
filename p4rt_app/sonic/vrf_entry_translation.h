...
#ifndef PINS_INFRA_P4RT_APP_SONIC_VRF_ENTRY_TRANSLATION_H_
#define PINS_INFRA_P4RT_APP_SONIC_VRF_ENTRY_TRANSLATION_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_VRF_ENTRY_TRANSLATION_H_
