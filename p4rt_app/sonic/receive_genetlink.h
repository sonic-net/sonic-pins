...
#ifndef PINS_INFRA_P4RT_APP_SONIC_RECEIVE_GENETLINK_H_
#define PINS_INFRA_P4RT_APP_SONIC_RECEIVE_GENETLINK_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_RECEIVE_GENETLINK_H_
