 ...
 */
#ifndef PINS_INFRA_P4RT_APP_SONIC_APP_DB_TO_PDPI_IR_TRANSLATOR_H_
#define PINS_INFRA_P4RT_APP_SONIC_APP_DB_TO_PDPI_IR_TRANSLATOR_H_
...
#endif  // PINS_INFRA_P4RT_APP_SONIC_APP_DB_TO_PDPI_IR_TRANSLATOR_H_
