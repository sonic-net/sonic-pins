...
#ifndef PINS_INFRA_P4RT_APP_TESTS_LIB_APP_DB_ENTRY_BUILDER_H_
#define PINS_INFRA_P4RT_APP_TESTS_LIB_APP_DB_ENTRY_BUILDER_H_
...
#endif  // PINS_INFRA_P4RT_APP_TESTS_LIB_APP_DB_ENTRY_BUILDER_H_
