...
absl::Status VerifySairedisRecOnNsfReboot(absl::string_view version,
  ...
  const auto allowlist = absl::flat_hash_set<absl::string_view>({
      "SAI_OBJECT_TYPE_DEBUG_COUNTER",      // TODO
      "SAI_OBJECT_TYPE_VIRTUAL_ROUTER",     // TODO
      "SAI_OBJECT_TYPE_ROUTER_INTERFACE",   // TODO
      "SAI_OBJECT_TYPE_HOSTIF_TRAP_GROUP",  // TODO(when cl/627750955 is
                                            // included in GPINS releases)
      "SAI_OBJECT_TYPE_HOSTIF",  // TODO(when cl/627750955 is included in GPINS
                                 // releases)
  });
