...
absl::StatusOr<P4SessionWithMockStub>
MakeP4SessionWithMockStub(const P4RuntimeSessionOptionalArgs &metadata);

p4::v1::Uint128
ConstructElectionId(const P4RuntimeSessionOptionalArgs &metadata);

p4::v1::MasterArbitrationUpdate
ConstructMasterArbitrationUpdate(const P4RuntimeSessionOptionalArgs &metadata);
...
p4::v1::WriteRequest
ConstructDeleteRequest(const P4RuntimeSessionOptionalArgs &metadata,
