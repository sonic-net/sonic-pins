...
(egress) ethernet.dstAddr: (let ((a!1 (ite (and true (= (concat #x0 #x800) ethernet.eth_type)) true false))
      (a!2 (ite (and true (= (bvand ipv4.srcAddr #x21210909) #x21210000))
                (ite true #b1 #b0)
                (ite false #b1 #b0)))
      (a!4 (ite (and true (= (bvand ipv4.srcAddr #x09210909) #x00210100))
                (concat #b000000000 #b1)
                (concat #b000000000 #b0))))
(let ((a!3 (ite (and true (= (bvand ipv4.srcAddr #x09210909) #x00210100))
                (ite true #b1 #b0)
                a!2))
      (a!5 (ite (and true
                     (= ((_ extract 31 24) ipv4.dstAddr)
                        ((_ extract 31 24) #x0a000000))
                     (= a!4 (concat #b000000000 #b0)))
                #x00000000000a
                ethernet.dstAddr)))
(let ((a!6 (ite (and true
                     (= ((_ extract 31 16) ipv4.dstAddr)
                        ((_ extract 31 16) #x14140000))
                     (= a!4 (concat #b000000000 #b1)))
                #x160000000016
                a!5)))
(let ((a!7 (ite (and true
                ...
                #x000000000000
                a!6)))
(let ((a!8 (ite (and true
                     (= ipv4.dstAddr #x0a0a0000)
                     (= a!4 (concat #b000000000 #b0)))
                #x000000000000
                a!7)))
  (ite a!1 (ite (bvuge a!3 #b1) a!8 ethernet.dstAddr) ethernet.dstAddr))))))
...
(let ((a!8 (ite (and true
                ...
                ethernet.dstAddr
                a!7)))
  (ite a!1 (ite (bvuge a!3 #b1) a!8 ethernet.srcAddr) ethernet.srcAddr))))))
...
(let ((a!8 (ite (and true
                ...
                (bvand (bvadd ipv4.ttl #xff) #xff)
                a!7)))
  (ite a!1 (ite (bvuge a!3 #b1) a!8 ipv4.ttl) ipv4.ttl))))))
...
(egress) scalars.local_metadata_t.vrf: (let ((a!1 (ite (and true (= (concat #x0 #x800) ethernet.eth_type)) true false))
      (a!2 (ite (and true (= (bvand ipv4.srcAddr #x09210909) #x00210100))
                (concat #b000000000 #b1)
                (concat #b000000000 #b0))))
  (ite a!1 a!2 (concat #b000000000 #b0)))
...
(let ((a!8 (ite (and true
                ...
                #b000000001
                a!7)))
(let ((a!9 (= (ite a!1 (ite (bvuge a!3 #b1) a!8 #b000000000) #b000000000)
              #b111111111)))
  (ite (not a!9)
       (ite a!1 (ite (bvuge a!3 #b1) a!8 #b000000000) #b000000000)
