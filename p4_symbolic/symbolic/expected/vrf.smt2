...
(assert
 (let (($x169 (= standard_metadata.ingress_port (_ bv1 9))))
 (or (or false (= standard_metadata.ingress_port (_ bv0 9))) $x169)))
(assert
...
(assert
 ...
 (let (($x91 (and (and true (= ipv4.dstAddr (_ bv168427520 32))) $x90)))
 (let (($x109 (and $x85 $x91)))
 (let ((?x70 (ite ipv4.$valid$ (ite $x83 (ite $x109 1 ?x149) (- 1)) (- 1))))
 (let (($x69 (ite ipv4.$valid$ (ite $x83 $x85 false) false)))
...
(assert
 ...
 (let (($x59 (and true (= (bvand ipv4.srcAddr (_ bv153159945 32)) (_ bv2162944 32)))))
 (let (($x65 (and $x53 $x59)))
 (let ((?x84 (ite ipv4.$valid$ (ite $x65 0 (ite (and $x53 $x64) 1 (- 1))) (- 1))))
 (let (($x71 (ite ipv4.$valid$ $x53 false)))
 (let ((?x50 (concat (_ bv0 9) (_ bv0 1))))
