...
(egress) h1.f8: h1.f8
(egress) h1.fr: h1.fr
(egress) h1.fw: (let ((a!1 (or (= h1.fr #x03)
               (and (not (= h1.fr #x03)) (not (= h1.fr #x04)) (= h1.fr #x05))))
      (a!2 (or (= h1.fr #x07)
               (and (not (= h1.fr #x07)) (not (= h1.fr #x08)) (= h1.fr #x09))))
      (a!3 (ite (and (not (= h1.fr #x01))
                     (not (= h1.fr #x02))
                     (not (= h1.fr #x03))
                     (not (= h1.fr #x04))
                     (not (= h1.fr #x05))
...
(let ((a!5 (ite (and (not (= h1.fr #x01))
                ...
                #x02
                a!4)))
(let ((a!6 (ite (and a!1 (not (= h1.fr #x01)) (not (= h1.fr #x02))) #x03 a!5)))
(let ((a!7 (ite (and (not (= h1.fr #x01)) (= h1.fr #x02)) #x02 a!6)))
  (ite (= h1.fr #x01) #x01 a!7))))))
...
(assert
 (let (($x111 (or (or false (= (_ bv0 9) (_ bv0 9))) (= (_ bv0 9) (_ bv1 9)))))
 (let (($x82 (= (_ bv0 9) (_ bv511 9))))
 (or $x82 $x111))))
(check-sat)
