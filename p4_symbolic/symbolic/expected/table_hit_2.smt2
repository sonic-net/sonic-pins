...
(assert
 (let (($x102 (= standard_metadata.ingress_port (_ bv7 9))))
 (let (($x97 (= standard_metadata.ingress_port (_ bv6 9))))
 (let (($x92 (= standard_metadata.ingress_port (_ bv5 9))))
 (let (($x87 (= standard_metadata.ingress_port (_ bv4 9))))
 (let (($x82 (= standard_metadata.ingress_port (_ bv3 9))))
 (let (($x78 (= standard_metadata.ingress_port (_ bv2 9))))
 (let (($x74 (= standard_metadata.ingress_port (_ bv1 9))))
 (let (($x79 (or (or (or false (= standard_metadata.ingress_port (_ bv0 9))) $x74) $x78)))
 (or (or (or (or (or $x79 $x82) $x87) $x92) $x97) $x102))))))))))
(assert
 ...
 (let (($x85 (or (or (or (or false (= ?x65 (_ bv0 9))) (= ?x65 (_ bv1 9))) (= ?x65 (_ bv2 9))) (= ?x65 (_ bv3 9)))))
 (let (($x105 (or (or (or (or $x85 (= ?x65 (_ bv4 9))) (= ?x65 (_ bv5 9))) (= ?x65 (_ bv6 9))) (= ?x65 (_ bv7 9)))))
