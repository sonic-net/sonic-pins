...
(egress) standard_metadata.egress_port: (ite (= ethernet.dst_addr #x000000000001)
     #b000000001
     standard_metadata.egress_port)
(egress) standard_metadata.egress_rid: #x0000
(egress) standard_metadata.egress_spec: (ite (= ethernet.dst_addr #x000000000001) #b000000001 #b111111111)
...
(assert
 (let (($x46 (or (or false (= (ite (= ethernet.dst_addr (_ bv1 48)) (_ bv1 9) (_ bv511 9)) (_ bv0 9))) (= (ite (= ethernet.dst_addr (_ bv1 48)) (_ bv1 9) (_ bv511 9)) (_ bv1 9)))))
 (let (($x32 (= ethernet.dst_addr (_ bv1 48))))
 (let ((?x40 (ite $x32 (_ bv1 9) (_ bv511 9))))
 (let (($x6 (= ?x40 (_ bv511 9))))
 (or $x6 $x46))))))
(check-sat)
