...
# Bold Green
echo -e "\033[1;32mUpdate successful\033[0m"

# Bold Red
echo -e "\033[1;31mYou may also need to regenerate our auto-generated test packets after P4 program updates. See go/packet-synthesizer for details.\033[0m";
