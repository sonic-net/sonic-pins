...
#ifndef PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_SAI_PD_UTIL_H_
#define PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_SAI_PD_UTIL_H_
...
#endif  // PINS_INFRA_SAI_P4_INSTANTIATIONS_GOOGLE_SAI_PD_UTIL_H_
