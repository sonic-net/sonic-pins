...
def pins_infra_deps():
    ...
    if not native.existing_rule("sonic_swss_common"):
        http_archive(
            ...
            url = "https://github.com/azure/sonic-swss-common/archive/1593cc64305c3df68f504c1555b78f5e1a483e62.zip",
            strip_prefix = "sonic-swss-common-1593cc64305c3df68f504c1555b78f5e1a483e62",
        )
