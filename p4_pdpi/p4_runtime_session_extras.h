...
absl::Status
InstallPdTableEntries(P4RuntimeSession &p4rt,
                      const google::protobuf::Message &pd_table_entries);
...
absl::Status
InstallPdTableEntry(P4RuntimeSession &p4rt,
...
ReadPiEntitiesSorted(P4RuntimeSession &p4rt);
...
ReadPiTableEntriesSorted(P4RuntimeSession &p4rt);
...
SendPiUpdatesAndReturnPerUpdateStatus(P4RuntimeSession &p4rt,
...
GetOrSetP4Info(pdpi::P4RuntimeSession &p4rt_session,
...
absl::Status DeleteIrEntities(P4RuntimeSession& p4rt, const IrEntities &ir_entities);
