...
#ifndef PINS_INFRA_P4_PDPI_PACKETLIB_READABLE_BIT_STRING_H_
#define PINS_INFRA_P4_PDPI_PACKETLIB_READABLE_BIT_STRING_H_
...
#endif  // PINS_INFRA_P4_PDPI_PACKETLIB_READABLE_BIT_STRING_H_
